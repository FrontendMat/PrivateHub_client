...
export const ThemeSwitcher = memo(({ className }: ThemeSwitcherProps) => {
    ...
    return (
        <label className={classNames(cls.switch, {}, [className])}>
            <span className={cls.sun}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="#ffd43b"><circle
            ...
            <span className={cls.moon}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path
